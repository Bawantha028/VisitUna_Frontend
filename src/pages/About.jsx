...
import { Award, Users, Heart, Camera, MapPin, Clock, Waves } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Discover the rich history, vibrant culture, and natural wonders that make 
              Unawatuna one of the world's most beloved beach destinations.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Nestled along Sri Lanka's southern coast, Unawatuna is a crescent-shaped bay 
                that has captivated travelers for generations. This pristine beach destination 
                combines natural beauty with rich cultural heritage, creating an unforgettable 
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                Unawatuna offers an authentic tropical paradise experience.
              </p>
              <div className="bg-blue-100 p-6 rounded-xl">
                <h4 className="font-semibold text-blue-900 mb-2">Did you know?</h4>
                <p className="text-blue-800">
                  Unawatuna was named one of the top 12 beaches in the world by Discovery Channel!
                </p>
              </div>
            </motion.div>
          </div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  <div className="flex-1">
                    <div className={`bg-white p-6 rounded-2xl shadow-lg ${index % 2 === 0 ? 'mr-8' : 'ml-8'}`}>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Why Choose Unawatuna?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="bg-blue-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <Waves className="h-8 w-8 text-blue-600" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Perfect Waters</h3>
                <p className="text-gray-600">
                  Crystal-clear waters protected by coral reefs, ideal for swimming and water sports.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Perfectly positioned near historic Galle Fort and other major attractions.
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Year-Round Beauty</h3>
                <p className="text-gray-600">
                  Tropical climate ensures beautiful weather and stunning sunsets throughout the year.
                </p>
              </div>
            </div>
          </motion.div>
